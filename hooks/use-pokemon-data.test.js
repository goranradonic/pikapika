...
const { usePokemonData, useEvolutionTriggers, usePokemonDetails } = require('./use-pokemon-data');
...
describe('usePokemonData', () => {
  ...
  it('should handle partial search when exact match fails', async () => {
    // Mock API responses
    fetchPokemonByName.mockRejectedValue(new Error('Pokemon "pika" not found'));
  ...
  it('should handle errors during fetch', async () => {
    ...
    fetchPokemonList.mockRejectedValue(new Error(errorMessage));
...
describe('useEvolutionTriggers', () => {
  ...
  it('should handle errors during fetch', async () => {
    // Mock API error
    const errorMessage = 'Network error';
    fetchEvolutionTriggers.mockRejectedValue(new Error(errorMessage));
...
describe('usePokemonDetails', () => {
  ...
  it('should handle errors during fetch', async () => {
    ...
    fetchPokemonByName.mockRejectedValue(new Error(errorMessage));
